...
const search_sagg=page.locator('#sac-autocomplete-results-container [role="row"]');
  const ProductName='shoes for woman';
...
//Login
  ...
  await page.locator("//input[@id='twotabsearchtextbox']").pressSequentially("shoe")
